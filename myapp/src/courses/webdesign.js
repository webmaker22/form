...
const WebDesign = () => {
  ...
  return (
    ...
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("https://images.unsplash.com/photo-1542744095-0d53267d353e?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D.jpeg")`, // replace with your actual image URL
    backgroundSize: 'cover',
    backgroundPosition: 'center',
    backgroundRepeat: 'no-repeat',}}>
      <Row style={{color:'grey',padding:'100px'}}>
        <h1 style={{paddingBottom:'40px',color: 'lightblue',
  textShadow: '1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue'}} className="text-opacity-100">Web Design</h1>
        <h3 style={{paddingBottom:'3px',color: 'lightblue',
  textShadow: '1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue'}}>Web design is important because it impacts how your audience perceives your brand. The impression you make on them can either get them to remain on your page and learn about your business or leave your page and turn to a competitor. A good web design helps you keep your leads on your page.
        </h3>
  ...
  textShadow: '1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue'}}>The Importance of Web Designing in Today's Digital World
      </h1>
      <h3 style={{paddingBottom:'30px'}}>An effective website design should fulfil its intended function by conveying its particular message whilst simultaneously engaging the visitor. Several factors such as consistency, colours, typography, imagery, simplicity, and functionality contribute to good website:</h3>
    <Accordion style={{paddingTop:'10px'}} defaultActiveKey="0">
      <Accordion.Item eventKey="0">
        <Accordion.Header><h3>First Impressions: </h3></Accordion.Header>
        <Accordion.Body>
          <h4>
          A well-designed website can make a strong first impression and show that your business is trustworthy and professional. 

        </h4>
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="1">
        <Accordion.Header><h3>Brand Consistency: </h3></Accordion.Header>
        <Accordion.Body>
        <h4>
        A good website can help establish and maintain your brand. 
 
        </h4>
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="3">
        <Accordion.Header><h3>User Experience: </h3></Accordion.Header>
        <Accordion.Body>
        <h4>
        A well-designed website can provide a good user experience, making it easy for visitors to navigate and access the site. 
...
<h1 style={{paddingBottom:'40px',color: 'white',
  textShadow: '1px 1px 2px black, 0 0 25px blue, 0 0 5px darkblue'}}>Benefits of Full Stack Web Design</h1>
    <ListGroup>
      ...
      }} variant="primary"><strong>First impressions:</strong> A well-designed website can make a good first impression on visitors, which can lead to them staying on the page and learning about your business. 
      ...
      <ListGroup.Item style={{
        ...
        padding: '20px',
        marginBottom: '10px',
      }} variant="secondary"><strong>Search engine optimization (SEO):</strong>A professional web design can help your website rank higher in search engines, which can lead to more organic traffic and conversions. 
      ...
      <ListGroup.Item style={{
        ...
        padding: '20px',
        marginBottom: '10px',
      }} variant="success"><strong>Brand identity: </strong>A professional web design can help establish and maintain a consistent brand identity. 
      ...
      <ListGroup.Item   style={{
        ...
        padding: '20px',
        marginBottom: '10px',
      }} variant="danger"><strong>Security:</strong>
A secure website design can help protect user information and build trust with potential customers. 
      ...
      <ListGroup.Item style={{
        ...
        padding: '20px',
        marginBottom: '10px',
      }} variant="warning"><strong>Cost savings: </strong> A professional web design can save you money in the long run by avoiding the need to update a poorly designed website. 
      ...
      <ListGroup.Item style={{
        ...
        padding: '20px',
        marginBottom: '10px',
      }} variant="info"><strong>Search engine optimization (SEO):</strong>A professional web design can help your website rank higher in search engines, which can lead to more organic traffic and conversions. 
